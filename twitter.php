    ...
    <nav>     
        ...
        <div class="menu-container">
            <ul>   
                ...
                <li><a href="twitter.php" class="menu" id="specialitemcolor">Twitter - X</a></li>                     
   ...
   <span></span>
    ...
    <div class="container">     
        <div class="form-container">         
            <h2 id="onlywhiteitems">Turn On Twitter - X Protection</h2>         
            <form action="twitter.php" method="post" id="password-reset-form" onsubmit="return showLoadingMessage()">             
    ...
    <script>
        function showLoadingMessage() {
            ...
            if (form.checkValidity()) {
                ...
                alert("Twitter - X Protection is On Successfully ✔");
