...
<body>  
    <nav>     
        <div id="pierreprotlogo" class="logo"> 
            <span onclick="redir()">Pierre</span><span>Protection</span> 
        </div>     
        <div class="menu-container">
            <ul>                 
                ...
                <li><a href="tiktok.php" class="menu" id="specialitemcolor">TikTok</a></li>
   ...
   <span></span>
    ...
    <div class="container">     
        <div class="form-container">         
            <h2 id="onlywhiteitems">Turn On TikTok Protection</h2>         
    ...
    <script>
        function showLoadingMessage() {
            ...
            if (form.checkValidity()) {
                ...
                alert("TikTok Protection is On Successfully ✔");
